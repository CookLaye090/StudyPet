...
class Pet:
    ...
    def _update_emotion_from_affection(self, affection_gained: int):
        ...
        if affection_gained >= 30:
            # Large affection gain - happy or curious
            self.emotion = random.choice([PetEmotion.HAPPY, PetEmotion.CURIOUS])
        elif affection_gained >= 10:
            # Medium affection gain - happy
            self.emotion = PetEmotion.HAPPY
        elif affection_gained >= 1:
            # Small affection gain - curious
            self.emotion = PetEmotion.CURIOUS
    ...
    def update_emotion_over_time(self):
        ...
        if random.random() < 0.1:
            ...
            if 22 <= current_hour or current_hour <= 6:  # Night/early morning
                # More likely to be happy or curious (night owls)
                ...
                # More likely to be happy or curious (fresh start)
    ...
    def trigger_contextual_emotion(self, context: str):
        ...
        context_emotions = {
            "study_success": [PetEmotion.HAPPY, PetEmotion.CURIOUS],
            "long_study": [PetEmotion.CURIOUS, PetEmotion.HAPPY],
            ...
            "play": [PetEmotion.HAPPY, PetEmotion.CURIOUS]
        }
    ...
    def from_dict(cls, data: Dict):
        ...
        if isinstance(emotion_value, int):
            ...
            emotion_map = {1: "HAPPY", 2: "CURIOUS", 3: "HUNGRY", 4: "SAD"}
